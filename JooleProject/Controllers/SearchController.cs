...
namespace JooleProject.Controllers
{
    public class SearchController : Controller
    {
        ...
        {
            var viewmodelResult = from p in db.tblProducts join k in db.tblSubCategories on p.SubCatID equals k.SubCatID select new SearchResultViewModel { product = p, subCategory = k };
